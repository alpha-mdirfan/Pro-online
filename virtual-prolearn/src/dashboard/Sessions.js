        ...
        <div className="d-flex">
            ...
            <div className="homeimage-content flex-grow-1 d-flex flex-column pt-100 home-b vh-100">
                ...
                <div className="d-flex flex-column  align-items-start mb-4 mt-10">
                    <span className="fs-4 fw-bold roboto">Build Sessions</span>
                    <button
                ...
                <div className="mt-2 home-content">
                    <span className="roboto fs-5 text-secondary fw-bold">
                        Your most recently created course will show up first. You can view, edit, copy and delete your Sessions. Once a course is published, you can invite your students to see it.
                    </span>
                </div>
            </div>
        </div>
